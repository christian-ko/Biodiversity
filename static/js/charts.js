...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var washes = parseFloat(firstSample.wfreq);
    ...
    var gaugeData = [{
      ...
      type: "indicator",
      mode: "gauge+number",
      title: { text: "<b>Belly Button Washing Frequency</b><br> Scrubs per Week", font: {color: "dodgerblue"} },
      gauge: {
